...
import { mainnet, arbitrum, base, optimism, polygon, zkSync, linea, scroll, mode, bsc, blast, zora, lisk, soneium, lens, megaeth, hyperEvm, monad, plasma, tempo } from 'wagmi/chains'
...
const wagmiConfig = getDefaultConfig({
  ...
  chains: [mainnet, arbitrum, base, optimism, polygon, zkSync, linea, scroll, mode, bsc, blast, zora, lisk, soneium, lens, megaeth, hyperEvm, monad, plasma, tempo, worldChain, unichain, ink],
  ssr: true,
})
